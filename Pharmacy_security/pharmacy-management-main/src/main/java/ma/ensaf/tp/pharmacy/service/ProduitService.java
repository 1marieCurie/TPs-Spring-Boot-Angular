...
public class ProduitService implements ProduitServiceInterface {
    ...
    @Override
    public Optional<Medicament> getProduitById(Long id) {
        return produitRepository.findById(id);
    }

    @Override
    public Medicament saveProduit(Medicament medicament) {
        return produitRepository.save(medicament);
    }

    @Override
    public Medicament updateProduit(Long id, Medicament produitDetails) {
